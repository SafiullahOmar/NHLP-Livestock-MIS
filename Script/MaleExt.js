$(function () {
    ...
    $('#ddlDistrict').change(function () {
        if ($(this).val() == "-1") {
            ...
            $.ajax({
                type: "POST",
                url: "MaleExtension.aspx/GetVillage",
                data: jsonObj,
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
...
function SaveVfu() {
    ...
    $.ajax({
        type: "POST",
        url: "MaleExtension.aspx/SaveBenef",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function ShowVfuList(DistrictId, Village,Year) {
    ...
    $.ajax({
        type: "POST",
        url: "MaleExtension.aspx/GetVfuLists",
        data: OB,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function EditVfuDetail(obj) {
    ...
    $.ajax({
        type: "POST",
        url: "MaleExtension.aspx/GetVfuDetailByID",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (r) {
...
function Update() {
    ...
    if ($('#hdnVfuId').val()) {
        $.ajax({
            type: "POST",
            url: "MaleExtension.aspx/UpdateFormDetail",
            data: jsonObject,
            dataType: "json",
            async: false,
            contentType: "application/json; charset=utf-8",
...
function Delete() {
    ...
    $.ajax({
        type: "POST",
        url: "MaleExtension.aspx/DeleteFarmer",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
