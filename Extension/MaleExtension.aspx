<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MaleExtension.aspx.cs" Inherits="Setup_Benefeciary" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentPageTitle" runat="Server">
    Male Extension VFU Worker Information
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentDescription" runat="Server">
    Fill VFU Personal and place information in below form .You are also allowed to edit and delete relevant information of MALE VFU Worker.
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="Server">
    <script src="../Script/MaleExt.js"></script>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        ...
                        <div id="Form1" class="form form-horizontal form-bordered">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-5 label-control" for="ddlVfuType">VFU Type</label>
                                            <div class="col-md-7">
                                                <select id="ddlVfuType" class="form-control">
                            ...
                            <div class="form-body">
                                <h4 class="form-section blue"><i class=" icon-save"></i>Male Extension Workers Basic Information</h4>
                                <div class="form-group row">
