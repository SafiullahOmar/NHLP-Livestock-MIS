...
public partial class Setup_Benefeciary : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<MaleVFU> GetMaleVFU(string ProvinceID,string Year)
    {
        List<MaleVFU> lst = new List<MaleVFU>();
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["LIVECon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandType = CommandType.StoredProcedure;
        com.CommandText = "sharedGetMaleFVU";
        com.Parameters.AddWithValue("@ProvinceId", SqlDbType.Int).Value = ProvinceID;
        ...
        while (dr.Read())
        {
            MaleVFU Dr = new MaleVFU();
            Dr.VFUDId = dr["VfuId"].ToString();
            Dr.VFUName = dr["MVFU"].ToString();
            lst.Add(Dr);
        }
        dr.Close();
        con.Close();
    ...
    public static bool SaveBenef(FormDetail formDetails)
    {
        ...
        try
        {
            ...
            p[11] = new SqlParameter("@VfuHead", SqlDbType.VarChar) { Value = formDetails.VfuHead };
            p[12] = new SqlParameter("@VfuLevel", SqlDbType.Int) { Value = 2 };
            p[13] = new SqlParameter("@ExtensionType", SqlDbType.NVarChar) { Value = "Female" };
    ...
    public static List<FormDetail> GetVfuLists(string DistrictId, string Village,string Year)
    {
        ...
        com.Parameters.AddWithValue("@VfuType", SqlDbType.VarChar).Value = "Female";
        com.Parameters.AddWithValue("@year", SqlDbType.Int).Value = Year;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
            ...
            p.VfuHead = dr["Vfu_Head"].ToString();
    ...
    public static void UpdateFormDetail(FormDetail formDetails)
    {
        ...
        try
        {
            ...
            p[10] = new SqlParameter("@Bank", SqlDbType.NVarChar) { Value = formDetails.BankNumber };
            p[11] = new SqlParameter("@VfuHead", SqlDbType.VarChar) { Value = formDetails.VfuHead };
            p[12] = new SqlParameter("@ExtensionType", SqlDbType.NVarChar) { Value ="Female" };
    ...
    public class MaleVFU
    {
        public string VFUDId { get; set; }
